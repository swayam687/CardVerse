/* ============================================================
   ...
   ============================================================ */
const Settings = {
  data: { theme: 'system', haptics: true, colorBlind: false, reducedMotion: false },
  ...
  apply() {
    ...
    Haptics.enabled = this.data.haptics;
  ...
  open() {
    ...
    cb1.onchange = () => { this.data.haptics = cb1.checked; this.save(); if (cb1.checked) Haptics.tap(); };
